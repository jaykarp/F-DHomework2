...
INSERT INTO stars (
SELECT DISTINCT actor_1_name FROM old_movies WHERE actor_1_name IS NOT NULL
UNION SELECT DISTINCT actor_2_name FROM old_movies WHERE actor_2_name IS NOT NULL
UNION SELECT DISTINCT actor_3_name FROM old_movies WHERE actor_3_name IS NOT NULL
UNION SELECT DISTINCT director_name FROM old_movies );
-- 8354 rows
...
INSERT INTO genres (
SELECT DISTINCT genre1 FROM old_movies WHERE genre1 IS NOT NULL
UNION SELECT DISTINCT genre2 FROM old_movies WHERE genre2 IS NOT NULL
UNION SELECT DISTINCT genre3 FROM old_movies WHERE genre3 IS NOT NULL
UNION SELECT DISTINCT genre4 FROM old_movies WHERE genre4 IS NOT NULL
UNION SELECT DISTINCT genre5 FROM old_movies WHERE genre5 IS NOT NULL);
-- 24 rows

INSERT INTO genres_movies (
SELECT DISTINCT movie_title,director_name,genre1 FROM old_movies WHERE genre1 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,genre2 FROM old_movies WHERE genre2 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,genre3 FROM old_movies WHERE genre3 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,genre4 FROM old_movies WHERE genre4 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,genre5 FROM old_movies WHERE genre5 IS NOT NULL);
-- 13698 rows

INSERT INTO keywords (
SELECT DISTINCT movie_title,director_name,keyword1 FROM old_movies WHERE keyword1 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,keyword2 FROM old_movies WHERE keyword2 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,keyword3 FROM old_movies WHERE keyword3 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,keyword4 FROM old_movies WHERE keyword4 IS NOT NULL
UNION SELECT DISTINCT movie_title,director_name,keyword5 FROM old_movies WHERE keyword5 IS NOT NULL);
-- 23035 rows
